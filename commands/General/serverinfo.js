    ...
    guild.members.fetch().then(fetchedMembers => {
      ...
      const embed = new Discord.MessageEmbed()
        ...
        .addField("**❯ General:**", [
          ...
          `**● Boosters:** ${this.client.customEmojis.boost.boost} ${guild.premiumSubscriptionCount}`,
          `**● Tier:** ${this.client.customEmojis.boost[guild.premiumTier]} Tier ${guild.premiumTier}`,
